...
mod stub_impl {
    ...
    impl LifetimesSpecifier {
        pub fn new(_reference_type_crawler: Arc<dyn IReferenceTypeCrawler>) -> Self {
            Self
        }
    }
...
mod actual_impl {
    ...
    impl crate::mock_macros::mock_generation::LifetimesSpecifier {
        pub fn new(reference_type_crawler: Arc<dyn IReferenceTypeCrawler>) -> Self {
            Self {
