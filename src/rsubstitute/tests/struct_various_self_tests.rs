...
mod __rsubstitute_generated_Struct {
    ...
    impl<'__rs> IGenericsInfoProvider for mutate_Call<'__rs> {
    ...
    impl<'__rs> IGenericsInfoProvider for mutate_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for consume_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for consume_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sbox_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sbox_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for src_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for src_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sarc_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sarc_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for spbox_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for spbox_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sprc_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sprc_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sparc_Call<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> IGenericsInfoProvider for sparc_ArgsChecker<'__rs> {
        fn get_generic_parameter_infos(&self) -> Vec<GenericParameterInfo> {
            vec![]
        }
        fn hash_generics_type_ids(&self, hasher: &mut GenericsHasher) {}
    ...
    impl<'__rs> Struct<'__rs> {
        pub fn mutate(&mut self) {
            let call: mutate_Call<'_> = mutate_Call {
        ...
        pub fn consume(self) -> i32 {
            let call: consume_Call<'_> = consume_Call {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            return self
        ...
        pub fn sbox(self: Box<Self>) -> i32 {
            let call: sbox_Call<'_> = sbox_Call {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            return self
        ...
        pub fn sarc(self: Arc<Self>) -> i32 {
            let call: sarc_Call<'_> = sarc_Call {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            return self
        ...
        pub fn spbox(self: Pin<Box<Self>>) -> i32 {
            let call: spbox_Call<'_> = spbox_Call {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            return self
        ...
        pub fn sprc(self: Pin<Rc<Self>>) -> i32 {
            let call: sprc_Call<'_> = sprc_Call {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            return self
        ...
        pub fn sparc(self: Pin<Arc<Self>>) -> i32 {
            let call: sparc_Call<'_> = sparc_Call {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            return self
    ...
    impl<'__rs> Struct<'__rs> {
        ...
        fn base_mutate(&self, call: mutate_Call<'__rs>) {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let mutate_Call::<'_> { .. } = call;
        }
        fn base_consume(&self, call: consume_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let consume_Call::<'_> { .. } = call;
            10
        }

        fn base_sbox(&self, call: sbox_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let sbox_Call::<'_> { .. } = call;
            212
        }
        fn base_src(&self, call: src_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let src_Call::<'_> { .. } = call;
            212
        }
        fn base_sarc(&self, call: sarc_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let sarc_Call::<'_> { .. } = call;
            212
        }

        fn base_spbox(&self, call: spbox_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let spbox_Call::<'_> { .. } = call;
            212
        }
        fn base_sprc(&self, call: sprc_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let sprc_Call::<'_> { .. } = call;
            212
        }
        fn base_sparc(&self, call: sparc_Call<'__rs>) -> i32 {
            #[allow(non_shorthand_field_patterns)]
            #[allow(unused_variables)]
            let sparc_Call::<'_> { .. } = call;
            212
        }
    }
    impl<'__rs> StructSetup<'__rs> {
        pub fn mutate<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), (), true, true> {
            let mutate_args_checker: mutate_ArgsChecker<'_> = mutate_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), (), true, true> =
        ...
        pub fn consume<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let consume_args_checker: consume_ArgsChecker<'_> = consume_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
                self.data.consume.add_config(consume_args_checker, self);
            return transmute_lifetime!(fn_tuner);
        }
        pub fn sbox<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let sbox_args_checker: sbox_ArgsChecker<'_> = sbox_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
        ...
        pub fn src<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let src_args_checker: src_ArgsChecker<'_> = src_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
        ...
        pub fn sarc<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let sarc_args_checker: sarc_ArgsChecker<'_> = sarc_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
        ...
        pub fn spbox<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let spbox_args_checker: spbox_ArgsChecker<'_> = spbox_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
        ...
        pub fn sprc<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let sprc_args_checker: sprc_ArgsChecker<'_> = sprc_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
        ...
        pub fn sparc<'__rsa>(&self) -> FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> {
            let sparc_args_checker: sparc_ArgsChecker<'_> = sparc_ArgsChecker {
                _phantom_lifetime: PhantomData,
                _phantom___rs: PhantomData,
            };
            let fn_tuner: FnTuner<'_, Struct<'__rs>, Self, (), i32, true, true> =
