...
mod __rsubstitute_generated_Struct {
    ...
    impl<'__rs> Struct<'__rs> {
        ...
        fn base_Trait_get_my_type<'a, TT: Clone>(
            &self,
            call: Trait_get_my_type_Call<'a, TT>,    // TODO ACHTUNG - requires to be '__rs 
        ) -> <Struct<'__rs> as Trait>::OutputType<TT>
        where
            Self: Clone + Sized,
            TT: ToString,
            ...
            '__rs: 'a
        {
            ...
            let Trait_get_my_type_Call::<'__rs, TT> { input: input, .. } = (call);
