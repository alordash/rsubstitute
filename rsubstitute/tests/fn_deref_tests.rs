...
mod tests {
    ...
    mod ref_tests {
        ...
        fn ref_test_Raw_ComparesByReference() {
            ...
            ref_test::setup(r1).does(move |_| calls_asserter.first());
            ...
            // Assert 1
            calls_asserter.assert_none_was_called();
            ...
            // Assert 2
            calls_asserter.assert_only_first_was_called();
    ...
    mod rc_tests {
        ...
        fn rc_test_Raw_ComparesByValue() {
            ...
            rc_test::setup(r1.clone()).does(move |_| calls_asserter.first());
        ...
        fn rc_test_RefEq_ComparesByReference() {
            ...
            rc_test::setup(Arg::ref_eq(r1.clone())).does(move |_| calls_asserter.first());
    ...
    mod arc_tests {
        ...
        fn arc_test_Raw_ComparesByValue() {
            ...
            arc_test::setup(r1.clone()).does(move |_| calls_asserter.first());
        ...
        fn arc_test_RefEq_ComparesByReference() {
            ...
            arc_test::setup(Arg::ref_eq(r1.clone())).does(move |_| calls_asserter.first());
    ...
    mod custom_tests {
        ...
        fn custom_test_Raw_ComparesByValue() {
            ...
            custom_test::setup(r1.clone()).does(move |_| calls_asserter.first());
        ...
        fn custom_test_RefEq_ComparesByReference() {
            ...
            custom_test::setup(Arg::ref_eq(r1.clone())).does(move |_| calls_asserter.first());
