...
mod accept_ref {
    use super::*;
    fn format_accept_ref_r<'b>(v: &&&&'b i32) -> String {
        use rsubstitute::for_generated::arg_printing::*;
        (&::rsubstitute::for_generated::ArgPrinter(v)).debug_string()
    }
    pub fn setup<'__rsa, 'b>(
        r: impl IntoArg<&'__rsa &'__rsa &'b i32>,
    ...
    impl<'__rsa, 'b> ::rsubstitute::for_generated::ICall for accept_ref_Call<'__rsa, 'b> {
        fn get_arg_infos(&self) -> Vec<::rsubstitute::for_generated::ArgInfo> {
            ...
            vec![::rsubstitute::for_generated::ArgInfo::new(
                "r",
                &self.r,
                format_accept_ref_r(::rsubstitute::transmute_lifetime!(&self.r, &&&&'b i32)),
            )]
        }
        ...
        fn check(
            ...
            vec![
                ...
                .check_ref(
                    ...
                    format_accept_ref_r(::rsubstitute::transmute_lifetime!(&call.r, &&&&'b i32)),
                ),
            ]
        }
    ...
    impl<'__rsa, 'b> accept_refStaticSetup<'__rsa, 'b> {
        ...
        > {
            let args_checker = accept_ref_ArgsChecker::<'__rsa, 'b> {
                __rs_generics: ::core::marker::PhantomData,
                r: ::rsubstitute::transmute_lifetime!(r.into_arg(format_accept_ref_r)),
            };
            let fn_data: &::rsubstitute::for_generated::FnData<
                '_,
                accept_refMock<'__rsa, 'b>,
...
fn generic<T1, T2>(t1: T1) -> T2 {
    use generic::*;
    let call = generic_Call::<'_, T1, T2> {
        __rs_generics: ::core::marker::PhantomData,
        t1: ::rsubstitute::transmute_lifetime!(t1),
    };
    let fn_data: &::rsubstitute::for_generated::FnData<
        '_,
        genericMock<'_, T1, T2>,
        ...
        false,
        false,
    > = ::rsubstitute::for_generated::get_static_fn_data("generic");
    fn_data.handle((), call)
}
#[allow(unused)]
#[allow(unreachable_pub)]
...
mod generic {
    use super::*;
    pub fn setup<'__rsa, T1, T2>(
        t1: impl IntoArg<T1>,
    ) -> ::rsubstitute::for_generated::FnConfigurator<
        '__rsa,
        genericMock<'__rsa, T1, T2>,
        genericStaticSetup<'__rsa, T1, T2>,
        (&'__rsa mut T1,),
        T2,
        genericMock<'__rsa, T1, T2>,
        true,
        ...
        false,
    > {
        ::rsubstitute::for_generated::clear_static_fn_data::<genericMock<'__rsa, T1, T2>>();
        genericStaticSetup::<'__rsa, T1, T2> {
            __rs_generics: ::core::marker::PhantomData,
        }
        .setup(t1)
    }
    pub fn received<'__rsa, T1, T2>(
        t1: impl IntoArg<T1>,
        times: ::rsubstitute::for_generated::Times,
    ) -> ::rsubstitute::for_generated::ArgRefsBinder<
        genericStaticReceived<'__rsa, T1, T2>,
        (&'__rsa mut T1,),
    > {
        genericStaticReceived::<'__rsa, T1, T2> {
            __rs_generics: ::core::marker::PhantomData,
    ...
    pub fn received_nothing<'__rsa, T1, T2>() {
        ::rsubstitute::for_generated::verify_static_fn_received_nothing_else::<
            genericMock<'_, T1, T2>,
        >()
    }
    #[doc(hidden)]
    pub struct generic_Call<'__rsa, T1, T2> {
        pub __rs_generics: ::core::marker::PhantomData<(&'__rsa (), Box<T1>, Box<T2>, T1)>,
        pub(super) t1: T1,
    }
    impl<'__rsa, T1, T2> ::rsubstitute::for_generated::IGenericsInfoProvider
        for generic_Call<'__rsa, T1, T2>
    {
        fn get_generic_parameter_infos(
            &self,
        ) -> Vec<::rsubstitute::for_generated::GenericParameterInfo> {
            vec![
                rsubstitute::for_generated::generic_type_info("T1", core::any::type_name::<T1>()),
                rsubstitute::for_generated::generic_type_info("T2", core::any::type_name::<T2>()),
            ]
        }
        fn hash_generics_type_ids(
            &self,
            ...
            ::core::hash::Hash::hash(
                &[
                    rsubstitute::for_generated::tid::<T1>(),
                    rsubstitute::for_generated::tid::<T2>(),
                ],
                hasher,
            );
        }
    ...
    impl<'__rsa, T1, T2> ::rsubstitute::for_generated::ICall for generic_Call<'__rsa, T1, T2> {
        fn get_arg_infos(&self) -> Vec<::rsubstitute::for_generated::ArgInfo> {
            use ::rsubstitute::for_generated::arg_printing::*;
            vec![::rsubstitute::for_generated::ArgInfo::new(
                "t1",
                &self.t1,
                fmt_generic_t1::<T1, T2>(::rsubstitute::transmute_lifetime!(&self.t1, &T1)),
            )]
        }
        fn get_ptr_to_boxed_tuple_of_refs(&self) -> *mut () {
            Box::leak(Box::new((&self.t1,))) as *mut _ as *mut ()
        }
    }
    fn fmt_generic_t1<T1, T2>(v: &T1) -> String {
        use ::rsubstitute::for_generated::arg_printing::*;
        (&::rsubstitute::for_generated::ArgPrinter(v)).debug_string()
    }
    #[doc(hidden)]
    struct generic_ArgsChecker<'__rsa, T1, T2> {
        pub __rs_generics: ::core::marker::PhantomData<(&'__rsa (), Box<T1>, Box<T2>, T1)>,
        t1: ::rsubstitute::for_generated::Arg<T1>,
    }
    impl<'__rsa, T1, T2> ::rsubstitute::for_generated::IGenericsInfoProvider
        for generic_ArgsChecker<'__rsa, T1, T2>
    {
        fn get_generic_parameter_infos(
            &self,
        ) -> Vec<::rsubstitute::for_generated::GenericParameterInfo> {
    ...
    impl<'__rsa, T1, T2> ::rsubstitute::for_generated::IArgsChecker
        for generic_ArgsChecker<'__rsa, T1, T2>
    {
        fn check(
            &self,
            ...
            use ::rsubstitute::for_generated::arg_printing::*;
            let call: &generic_Call<'__rsa, T1, T2> = dyn_call.downcast_ref();
            vec![
                ::rsubstitute::transmute_lifetime!(
                    &self.t1,
                    &::rsubstitute::for_generated::Arg::<T1>
                )
                .check(
                    "t1",
                    ::rsubstitute::transmute_lifetime!(&call.t1),
                    (&::rsubstitute::for_generated::ArgPrinter(
                        ::rsubstitute::transmute_lifetime!(&call.t1, &T1),
                    ))
                        .debug_string(),
                ),
            ]
    ...
    pub struct genericMock<'__rsa, T1, T2> {
        pub __rs_generics: ::core::marker::PhantomData<(&'__rsa (), Box<T1>, Box<T2>, T1)>,
    }
    #[doc(hidden)]
    pub struct genericStaticSetup<'__rsa, T1, T2> {
        pub __rs_generics: ::core::marker::PhantomData<(&'__rsa (), Box<T1>, Box<T2>, T1)>,
    }
    impl<'__rsa, T1, T2> genericStaticSetup<'__rsa, T1, T2> {
        pub fn setup(
            &self,
            t1: impl IntoArg<T1>,
        ) -> ::rsubstitute::for_generated::FnConfigurator<
            ...
            false,
        > {
            let args_checker = generic_ArgsChecker::<'__rsa, T1, T2> {
                __rs_generics: ::core::marker::PhantomData,
                t1: ::rsubstitute::transmute_lifetime!(t1.into_arg(fmt_generic_t1::<T1, T2>)),
            };
            let fn_data: &::rsubstitute::for_generated::FnData<
                '_,
                genericMock<'__rsa, T1, T2>,
    ...
    #[doc(hidden)]
    pub struct genericStaticReceived<'__rsa, T1, T2> {
        pub __rs_generics: ::core::marker::PhantomData<(&'__rsa (), Box<T1>, Box<T2>, T1)>,
    }
    impl<'__rsa, T1, T2> ::core::clone::Clone for genericStaticReceived<'__rsa, T1, T2> {
        #[inline]
        fn clone(&self) -> genericStaticReceived<'__rsa, T1, T2> {
            genericStaticReceived::<'__rsa, T1, T2> {
                __rs_generics: ::core::clone::Clone::clone(&self.__rs_generics),
            }
        }
    }
    impl<'__rsa, T1, T2> genericStaticReceived<'__rsa, T1, T2> {
        pub fn received(
            &self,
            t1: impl IntoArg<T1>,
            times: ::rsubstitute::for_generated::Times,
        ) -> ::rsubstitute::for_generated::ArgRefsBinder<Self, (&'__rsa mut T1,)> {
            let args_checker = generic_ArgsChecker::<'__rsa, T1, T2> {
                __rs_generics: ::core::marker::PhantomData,
                t1: ::rsubstitute::transmute_lifetime!(t1.into_arg(fmt_generic_t1::<T1, T2>)),
            };
